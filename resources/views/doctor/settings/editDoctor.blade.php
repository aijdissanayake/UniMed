                        ...
                        <div class="card-content">
                            <form action="{{route('updateDoctor',['id'=>$doctor->id])}}" method="post">
                                    ...
                                    <div class="col s12 m3 l3  ">
                                        <div class="section"><span>Gender<span class="red-text">*</span></span>
                                            ...
                                            @else
                                                ...
                                                <p>
                                                    <input type="radio" name="gender" value="0" checked="true" id="gender_female">
                                                    <label for="gender_female">Female</label>
                                                </p>
                                            @endif
                                        </div>
                                ...
                                <div class="section">
                                    ...
                                    <a class='form_settings' href="#"><button class="btn" name="backButton" value="Back">Back</button></a></p>
                                </div>
                            </div>
                        </form>
