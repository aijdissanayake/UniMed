    ...
    <nav>
        <div class="nav-wrapper blue">
            ...
            <ul class="right hide-on-med-and-down">
                <li><a href="{{route('lt')}}" class="dropdown-button" data-activates="dropdown2" data-beloworigin="true" data-hover="true" data-constrainwidth="false">Home<i class="material-icons right">arrow_drop_down</i></a></li>
