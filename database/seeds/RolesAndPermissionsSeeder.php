...
class RolesAndPermissionsSeeder extends Seeder {
    ...
    protected $roles = [
        ...
        'admin' => [                            // internal name of role
            'display_name' => 'Administrator',
            'description' => 'administer the website and manage users',
            'permissions' => []
        ],
        
        'doctor' => [                            // internal name of role
            'display_name' => 'Doctor',
            'description' => 'manages the users',
            'permissions' => []
        ],
        
        'assist' => [                            // internal name of role
            'display_name' => 'Assistant',
            'description' => 'eneters certain records',
            'permissions' => []
        ],
        
        'labtech' => [                            // internal name of role
            'display_name' => 'Lab technician',
            'description' => 'eneters certain records',
            'permissions' => []
        ],
        
        'patient' => [                            // internal name of role
            'display_name' => 'Patient',
            'description' => 'views data relevent to him or her',
            'permissions' => []
        ],
    ];
